      ...
      <div className="containerFooter">
        ...
        <div className="nav-links">
          <div className="nav-section">
            <h3>Services</h3>
            <ul>
              <li><a href="https://mento.in">Home</a></li>
              <li><a href="https://mento.in/about/">About us</a></li>
              <li><a href="https://mento.in/contact/">Connect to us</a></li>
              <li><a href="https://mento.in/mental-wellness/">Get a Therapy</a></li>
            </ul>https://mento.in/mental-wellness/
          </div>
          <div className="nav-section">
            <h3>Resources</h3>
            <ul>
              <li><a href="https://mento.in/blog/">Blogs</a></li>
          ...
          <div className="nav-section">
            <h3>Others</h3>
            <ul>
              <li><a href="https://mento.in/about/">Our Story</a></li>
              <li><a href="https://mento.in">Our Team</a></li>
